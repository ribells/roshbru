...
const faceMesh = new FaceMesh({locateFile: (file) => {
  // return https://cdn.jsdelivr.net/npm/@mediapipe/face_mesh@0.1/face_mesh_solution_packed_assets_loader.js
  // then loads https://github.com/davideloba/facemesh/blob/master/face_mesh_solution_packed_assets.data
